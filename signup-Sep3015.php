...
<div class="loginMnDiv">
  <div class="loginDiv">
    <div class="box-login">
      <div>
        <label class="left logoTxt"><span>Dana</span>ye </label>
      ...
      <div class="memberLogin" style="display:block;"> Create Account
            ...
            <li>
              <div class="fieldDiv">
                <div id="frmCheckUsername">
                  <input name="email" type="email" style="width:80%;" placeholder="Email" class="demoInputBox"  required="required"  id="username"  onBlur="checkAvailability()" />
