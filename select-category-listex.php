...
<div  class="selectviewDiv">
	<ul>
    	  	<li class="active"><a href="select-category-list.php"><i class="fa fa-bars"></i> List</a></li>
...
<ul>
    ...
    <li>
     <i class="fa fa-star" style="color:#bdbdbd;"></i>  Karnataka Jain Matrimonial - <span>Bangalore</span> - <a href="javscript:void();">[x]</a>
     <span class="postTxt">Posted on : <small>Aug 28, 2015</small></span>
    </li>
    <li>
