...
echo ucfirst($territory_name['sub_categories_name']);
    ...
    <div class="selectTabDiv">
      <div  class="selectviewDiv">
        ...
        <li class="active"><a href="select-category-gallery.php?city_id=<?php echo $city_id;?>&categoty_id=<?php echo $categoty_id;?>&sub_categories_id=<?php echo $sub_categories_id;?>"><i class="fa fa-th-large"></i> Gallery</a></li>
    ...
    <div class="gallery_description" style="padding:10px 0px;">
      <ul id="freewall">
      </ul>
