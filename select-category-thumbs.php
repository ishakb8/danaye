...
echo ucfirst($territory_name['sub_categories_name']);
    ...
    <div class="selectTabDiv">
      <div  class="selectviewDiv">
        <ul>
    	<li><a href="select-category-list.php?city_id=<?php echo $city_id;?>&categoty_id=<?php echo $categoty_id;?>&sub_categories_id=<?php echo $sub_categories_id;?>"><i class="fa fa-bars"></i> List</a></li>

        <li class="active"><a href="select-category-thumbs.php?city_id=<?php echo $city_id;?>&categoty_id=<?php echo $categoty_id;?>&sub_categories_id=<?php echo $sub_categories_id;?>"><i class="fa fa-th-list"></i> Thumbs</a></li>
    ...
    <div class="gallery_description_thumbs" style="padding:10px 0px;">
      <ul id="freewall">
      </ul>
